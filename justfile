...
clean:
    ...
    @docker container prune -f --filter "label=com.docker.compose.project=llustr*"
...
show-config tunnel:
    @VPN_CONFIG_NUM={{tunnel}} SOCKS_PORT=1080 COMPOSE_PROJECT_NAME=llustr-{{tunnel}} docker compose config
